...
custom_databases = {'tigbot.db': ['ai_logs', 'bot_logs', 'generated_vc', 'generated_vc_hist', 'user_data', 'user_message_log', 'message_blacklist', 'image_blacklist', 'restrictions', 'command_calls']}

# keys are defining table names, values are the names of defined variables from "custom_vars"
custom_tables = {'ai_logs': ['username', 'userid', 'user_ai_prompt', 'ai_response', 'guild_id','timestamp'],
...
custom_vars = {"username": "str",   # the username of a user
